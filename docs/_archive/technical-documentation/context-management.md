...
export class ContextEngine {
  ...
  async getSpecContext(projectPath: string, specName: string): Promise<SpecContext> {
  ...
  private async loadSpecFromFS(projectPath: string, specName: string): Promise<SpecContext> {
