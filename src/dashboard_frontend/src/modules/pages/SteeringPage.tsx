...
function SteeringModal({
  ...
  document: SteeringDocument | null;
  isOpen: boolean;
  onClose: () => void;
}) {
...
function SteeringDocumentRow({
  document,
  onOpenModal,
}: {
  document: SteeringDocument;
  onOpenModal: (document: SteeringDocument) => void;
}) {
  const { t } = useTranslation();
  return (
    <tr
      ...
      <td className="px-4 py-4">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <div className="text-sm text-[var(--text-secondary)]">{document.name}.md</div>
          </div>
        </div>
      </td>
      <td className="px-4 py-4">
                ...
                <div className="flex items-center flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {doc.exists
                          ? t('steeringPage.badge.available')
                          : t('steeringPage.badge.notCreated')}
                      </span>
                    </div>
                    <div className="flex items-center mt-1">
                      <p className="text-sm text-[var(--text-secondary)]">{doc.name}.md</p>
